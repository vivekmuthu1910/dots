...
try
	...
	call denite#custom#var('grep', 'default_opts', ['--vimgrep', '--smart-case', '--heading', '-S'])
	...
	"   <CR>         - Switch to normal mode inside of search results
...
try
	...
	echo 'NERDCommenter Not Installed'
endtry
" }}}
...
try
	...
	echo 'Colorscheme is not Installed'
endtry
